...
- [ChoiceBox](../../docs/components/lists/choice-box)
- [ComboBox](../../docs/components/lists/combo-box)
...
With `24.11`, it's now possible to asynchronously call a specified JavaScript function or execute provided JavaScript code without returning a result to the server. This can be done on a specific [`Element`](../../docs/building-ui/elements), or within the entire app by utilizing the `Page` instance. 

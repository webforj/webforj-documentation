...
import pages.ColumnsLayoutPage.ColumnsLayoutViewPage;
import tests.BaseTest;
import utils.annotations.BrowserTest;

public class ColumnsLayoutViewIT extends BaseTest {

    private ColumnsLayoutViewPage columnsLayout;

    @BeforeEach
    public void navigateColumnsLayout() {
        navigateToRoute(ColumnsLayoutViewPage.getRoute());
        columnsLayout = new ColumnsLayoutViewPage(page);
    }

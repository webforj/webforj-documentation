package tests.MaskedFields.MaskedTextFieldTest;
...
import pages.MaskedFields.MaskedTextFieldPage;
...
public class MaskedTextFieldWithRestoreValueTestsIT extends BaseTest {
    ...
    void setupMaskedTextFieldWithRestoreValueTests() {
        page.navigate("https://docs.webforj.com/webforj/maskedtextfieldrestore?");

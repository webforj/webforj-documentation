...
import pages.GoogleChartsPages.ChartRedrawPage;
import tests.BaseTest;
import utils.annotations.BrowserTest;

public class ChartRedrawTestsIT extends BaseTest {

    private ChartRedrawPage chartRedraw;

    @BeforeEach
    public void navigateToChartRedraw() {
        page.navigate("https://docs.webforj.com/webforj/chartredraw?");
    ...
    public void testChartRedraw() {
        Locator title = page.locator("text=Social Media Following");
        assertThat(title).hasText("Social Media Following");
    ...
    public void testNoValueInput() {
        chartRedraw.cleanField(chartRedraw.getValueForInstagram());
        chartRedraw.getUpdateButton().click();

package com.webforj.samples.pages.fields.maskedtextfield;
...
public class MaskedTextFieldPage extends BasePage {
    ...
    private static final String ROUTE_VIEW = "maskedtextfield";
    private static final String ROUTE_RESTORE = "maskedtextfieldrestore";
    private static final String ROUTE_SPINNER = "maskedtextfieldspinner";

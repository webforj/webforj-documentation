  ...
  public AccordionMultiplePage(Page page) {
    this.panelA =
        page.locator("dwc-accordion-panel")
            .filter(new Locator.FilterOptions().setHasText("Panel A"));
    this.panelB =
        page.locator("dwc-accordion-panel")
            .filter(new Locator.FilterOptions().setHasText("Panel B"));
    this.panelC =
        page.locator("dwc-accordion-panel")
            .filter(new Locator.FilterOptions().setHasText("Panel C"));
    this.openAllButton =
        page.getByRole(AriaRole.BUTTON, new Page.GetByRoleOptions().setName("Open All"));
    this.closeAllButton =

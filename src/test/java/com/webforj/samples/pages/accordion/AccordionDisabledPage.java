  ...
  public AccordionDisabledPage(Page page) {
    this.disabledPanel =
        page.locator("dwc-accordion-panel")
            .filter(new Locator.FilterOptions().setHasText("This panel is disabled"));
    this.disabledOpenedPanel =
        page.locator("dwc-accordion-panel")
            .filter(new Locator.FilterOptions().setHasText("Disabled but opened"));

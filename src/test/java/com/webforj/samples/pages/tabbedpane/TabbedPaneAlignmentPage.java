...
public class TabbedPaneAlignmentPage {
  ...
  public TabbedPaneAlignmentPage(Page page) {
    ...
    this.alignmentDropdown =
        page.getByRole(AriaRole.BUTTON, new Page.GetByRoleOptions().setName("AUTO"));
    this.alignmentDropdownButton =
        page.getByRole(AriaRole.OPTION, new Page.GetByRoleOptions().setName("CENTER"));

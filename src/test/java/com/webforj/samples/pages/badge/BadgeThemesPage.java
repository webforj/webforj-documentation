...
public class BadgeThemesPage {
    ...
    public BadgeThemesPage(Page page) {
        this.primaryBadge = page.locator("dwc-badge").filter(
                new Locator.FilterOptions().setHasText("Primary")).first();
        this.successBadge = page.locator("dwc-badge").filter(
                new Locator.FilterOptions().setHasText("Success")).first();
        this.dangerBadge = page.locator("dwc-badge").filter(
                new Locator.FilterOptions().setHasText("Danger")).first();
        this.outlinedPrimaryBadge = page.locator("dwc-badge").filter(
                new Locator.FilterOptions().setHasText("Primary")).last();
        this.outlinedSuccessBadge = page.locator("dwc-badge").filter(

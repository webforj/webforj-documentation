...
public class LoginCustomFieldsPage {
  ...
  public LoginCustomFieldsPage(Page page) {
    ...
    customerID =
        page.getByRole(
            AriaRole.TEXTBOX, new Page.GetByRoleOptions().setName("Customer ID").setExact(false));
    username =
        page.getByRole(
            AriaRole.TEXTBOX, new Page.GetByRoleOptions().setName("Username").setExact(false));
    password =
        page.getByRole(
            AriaRole.TEXTBOX, new Page.GetByRoleOptions().setName("Password").setExact(false));

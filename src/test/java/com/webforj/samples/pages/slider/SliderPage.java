...
public class SliderPage {
  ...
  public SliderPage(Page page) {
    ...
    this.volumeOffButton =
        page.getByRole(AriaRole.BUTTON, new Page.GetByRoleOptions().setName("volume off"));
    this.volumeOnButton =
        page.getByRole(AriaRole.BUTTON, new Page.GetByRoleOptions().setName("volume 2"));

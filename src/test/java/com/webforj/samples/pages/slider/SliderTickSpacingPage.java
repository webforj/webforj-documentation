...
public class SliderTickSpacingPage {
  ...
  public SliderTickSpacingPage(Page page) {
    ...
    this.snapToTicks =
        page.getByRole(AriaRole.RADIO, new Page.GetByRoleOptions().setName("Snap to Ticks"));
    this.showTicks =
        page.getByRole(AriaRole.RADIO, new Page.GetByRoleOptions().setName("Show Ticks"));
  }

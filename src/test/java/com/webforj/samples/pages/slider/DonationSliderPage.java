...
public class DonationSliderPage {
  ...
  public DonationSliderPage(Page page) {
    ...
    this.donationButton =
        page.getByRole(AriaRole.BUTTON, new Page.GetByRoleOptions().setName("Confirm Donation"));
    this.confirmationToast =
        page.getByText(Pattern.compile("Thank you for your generous contribution of \\$\\d+!"));

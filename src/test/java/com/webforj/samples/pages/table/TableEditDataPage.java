...
public class TableEditDataPage {
  ...
  public TableEditDataPage(Page page) {
    ...
    this.editButton =
        page.getByRole(AriaRole.BUTTON, new Page.GetByRoleOptions().setName("pencil pin")).nth(0);
  ...
  public Locator verifyTitle(String title) {
    return page.getByRole(AriaRole.CELL, new Page.GetByRoleOptions().setName(title));
  }
}

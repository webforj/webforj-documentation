...
public class IconVariationsPage {
  ...
  public IconVariationsPage(Page page) {
    ...
    envelopeIcon = page.getByRole(AriaRole.IMG, new Page.GetByRoleOptions().setName("envelope"));
    solidEnvelopeIcon =
        page.getByRole(AriaRole.IMG, new Page.GetByRoleOptions().setName("fas-envelope"));
    instagramIcon =
        page.getByRole(AriaRole.IMG, new Page.GetByRoleOptions().setName("fab instagram"));
    calendarIcon = page.getByRole(AriaRole.IMG, new Page.GetByRoleOptions().setName("calendar"));
    filledCalendarIcon =

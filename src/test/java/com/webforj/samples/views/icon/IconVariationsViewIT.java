...
public class IconVariationsViewIT extends BaseTest {
  ...
  private final String CALENDAR_ICON_URL =
      "https://cdn.jsdelivr.net/npm/@tabler/icons@latest/icons/outline/calendar.svg";
  private final String FILLED_CALENDAR_ICON_URL =
      "https://cdn.jsdelivr.net/npm/@tabler/icons@latest/icons/filled/calendar.svg";
  private final String ENVELOPE_ICON_URL =
      "https://cdn.jsdelivr.net/npm/@fortawesome/fontawesome-free@latest/svgs/regular/envelope.svg";
  private final String SOLID_ENVELOPE_ICON_URL =
      "https://cdn.jsdelivr.net/npm/@fortawesome/fontawesome-free@latest/svgs/solid/envelope.svg";

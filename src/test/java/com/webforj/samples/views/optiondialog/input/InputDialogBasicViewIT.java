...
public class InputDialogBasicViewIT extends BaseTest {
  ...
  public void testInvalidInputDialogIsShownWhenDeleteButtonIsClicked() {
    ...
    Locator deleteButton =
        page.getByRole(AriaRole.BUTTON, new Page.GetByRoleOptions().setName("Delete Repository"));
    deleteButton.click();

    Locator errorDialog =
        page.getByText("Failed to delete the repository. Code entered is incorrect");

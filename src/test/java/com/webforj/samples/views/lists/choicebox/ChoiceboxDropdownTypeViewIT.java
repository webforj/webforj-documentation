...
public class ChoiceboxDropdownTypeViewIT extends BaseTest {
  ...
  public void testChoiceboxDropdownTypeSelected() {
    ...
    Locator choiceBoxElectronics =
        page.getByRole(AriaRole.BUTTON, new Page.GetByRoleOptions().setName("Electronics"));
    choiceBoxElectronics.click();

    Locator kitchenDropdown =
        page.getByRole(AriaRole.OPTION, new Page.GetByRoleOptions().setName("Kitchen"));
    kitchenDropdown.click();

    Locator choiceBoxKitchen =
        page.getByRole(AriaRole.BUTTON, new Page.GetByRoleOptions().setName("Kitchen"));

...
class TabbedPanePlacementKotlinView: Composite<Div>() {
  private val self = boundComponent

  init {
    self.apply {
      classNames + "window"
      val placements = choiceBox("Placement") {
        width = 200.px
        items(*TabbedPane.Placement.entries
      ...
      tabbedPane {
        ...
        placements.onSelect { placement = it.selectedItem.key as TabbedPane.Placement }
      }
    }
  }

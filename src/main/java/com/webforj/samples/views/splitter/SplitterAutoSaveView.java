...
public class SplitterAutoSaveView extends Composite<Div> {
  ...
  public SplitterAutoSaveView() {
    ...
    Splitter topSplitter =
        new Splitter("topSplitter", topLeft, topRight).setPositionRelative(30).setAutosave(true);
    ...
    Splitter bottomSplitter =
        new Splitter("bottomSplitter", bottomLeft, bottomRight)
            .setPositionRelative(75)
            .setAutosave(true);

    Splitter masterSplitter =
        new Splitter("masterSplitter", topSplitter, bottomSplitter)
    ...
    FlexLayout layout =
        FlexLayout.create(toolbar, masterSplitter)
            .vertical()
            .build()

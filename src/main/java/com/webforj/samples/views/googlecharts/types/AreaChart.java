  ...
  public AreaChart() {
    Map<String, Object> options =
        Map.of(
            ...
            "Market Trends",
            "colors",
            List.of("#34a853", "#4285f4", "#fbbc05", "#ea4335"),
            "backgroundColor",
            "transparent",
            "hAxis",
            Map.of(
                TITLE, "Year", TEXT_STYLE, Map.of("bold", true, "fontSize", 12, COLOR, "#4d4d4d")),
            "vAxis",
            Map.of(
                TITLE, "Value", TEXT_STYLE, Map.of("bold", true, "fontSize", 12, COLOR, "#4d4d4d")),
            "isStacked",
            true);

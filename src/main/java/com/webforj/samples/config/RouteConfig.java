...
public final class RouteConfig {
    ...
    public static final String APP_LAYOUT_FULL_NAVBAR = "applaloutfullnavbar";
    public static final String APP_LAYOUT_MOBILE_DRAWER = "applaloutmobiledrawer";
    public static final String APP_LAYOUT_MULTIPLE_HEADERS = "applaloutmultipleheaders";
    public static final String APP_LAYOUT_STICKY_TOOLBAR = "applalloutstickytoolbar";
    ...
    public static final String ICON_ACTIONS_BUTTONS = "iconactionsbuttons";
    ...
    public static final String TOAST_BASIC     = "toastbasic";

...
### Using prefix and suffix slots {#using-prefix-and-suffix-slots}
...
#### Icons across multiple collections {#icons-across-multiple-collections}
...
#### Adding a custom icon pool {#adding-a-custom-icon-pool}
...
### Void asynchronous JavaScript execution {#void-asynchronous-javascript-execution}
...
### Using the `Page` for HTML event registration {#using-the-page-for-html-event-registration}

...
import terminalVideo from '/release_blog/terminal.mp4';

![cover image](/release_blog/_images/24.10.png)
...
### `TextArea` and masked input component {#textarea-and-masked-input-component}
...
### `BusyIndicator`, `Loading` and `Spinner` components {#busyindicator-loading-and-spinner-components}
...
### Slider overhaul {#slider-overhaul}
...
### Rendering HTML in components {#rendering-html-in-components}

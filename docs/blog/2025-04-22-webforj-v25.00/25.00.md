...
![cover image](/release_blog/_images/25.00.png)
...
## Servlet 6 or later {#servlet-6-or-later}
...
## `InfiniteScroll` & `Refresher` components {#infinitescroll--refresher-components}
...
### Borders and striped rows {#borders-and-striped-rows}
...
#### Customizable table borders {#customizable-table-borders}
...
#### Striped rows for improved readability {#striped-rows-for-improved-readability}
...
![cover image](/release_blog/_images/table_sorting.png)
...
#### When and how notifications appear {#when-and-how-notifications-appear}

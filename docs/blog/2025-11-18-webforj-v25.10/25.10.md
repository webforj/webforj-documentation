...
## Webswing integration for progressive modernization {#webswing-integration-for-progressive-modernization}
...
## Route Security with Spring Security integration {#route-security-with-spring-security-integration}
...
## Login component enhancements {#login-component-enhancements}
...
## Textual date parsing for masked date fields {#textual-date-parsing-for-masked-date-fields}
...
## Flexible entity key identification for repositories {#flexible-entity-key-identification-for-repositories}

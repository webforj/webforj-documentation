...
<!-- TODO: Detail from PR #1065 - https://github.com/webforj/webforj/pull/1065 -->

The `Table` component gains powerful new column manipulation features, allowing users to resize and reorder columns directly in the UI for a more customizable data viewing experience.

#### Key features

- **Column resizing**: Users can drag column borders to adjust width
- **Column reordering**: Drag and drop columns to rearrange their order
- **Persistence support**: Save and restore column preferences
- **Programmatic control**: Set column widths and order via API
- **Min/max constraints**: Define minimum and maximum column widths

#### Example implementation

<!-- TODO: Add table column examples and possibly a video demo after reviewing PR -->

```java
// Example placeholder - to be updated with actual API from PR
```
...
<!-- TODO: Add any breaking changes or migration notes -->
...
<!-- TODO: Add forward-looking statement about future releases -->

webforJ `25.03` strengthens the framework's enterprise capabilities with enhanced Spring integration and improved component functionality. We're excited to see what you build with these new features!

For questions or feedback, join our [community discussions](https://github.com/webforj/webforj/discussions) or report issues on [GitHub](https://github.com/webforj/webforj/issues).
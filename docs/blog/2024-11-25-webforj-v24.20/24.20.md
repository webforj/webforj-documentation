...
<!-- vale off -->
### WAR Deployment in webforJ {#war-deployment-in-webforj}
<!-- vale on -->
...
### Updating your project for WAR deployment {#updating-your-project-for-war-deployment}
...
```
### Configuration with `webforj.conf` {#configuration-with-webforjconf}
...
### Configuring the `web.xml` file {#configuring-the-webxml-file}

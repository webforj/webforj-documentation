...
See the upgrade guide to ensure a smooth transition from webforJ 24 to 25
:::
...
```
#### Browser limitations
While this works in most modern browsers like Chrome and Firefox, some features such as notification icons may not display in Safari. Additionally, browsers restrict programmatic focus behavior after a notification click for security and UX reasons.

...
### Early lifecycle hooks for configuration management {#early-lifecycle-hooks-for-configuration-management}
...
### Spring properties file configuration support {#spring-properties-file-configuration-support}
...
### Spring MVC coexistence at root path {#spring-mvc-coexistence-at-root-path}
...
### Spring custom scopes for webforJ environments and routes {#spring-custom-scopes-for-webforj-environments-and-routes}
...
### Table column sizing and moving support {#table-column-sizing-and-moving-support}
...
### SessionObjectTable for HTTP session-scoped storage {#sessionobjecttable-for-http-session-scoped-storage}
...
### Router Activate lifecycle event for cached components {#router-activate-lifecycle-event-for-cached-components}
...
### Automatic browser launch for Spring Boot development {#automatic-browser-launch-for-spring-boot-development}

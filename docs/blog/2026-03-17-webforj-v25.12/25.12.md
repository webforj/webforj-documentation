...
The `Table` component picks up two major new features in `25.12`: [**column groups**](/docs/components/table/table_column_groups) for organizing complex headers, and a [**library of built-in cell renderers**](/docs/components/table/rendering#built-in-renderers) that eliminates the need for custom rendering boilerplate.

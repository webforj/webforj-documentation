...
function isDocAutoGenerated() {
  try {
    useDoc();
    return false;
  } catch {
    // Using useDoc on auto generated pages throws a ReactContextError
    return true;
    }
  }
...
function AskMenu() {
  ...
  const metadata = !isDocAutoGenerated() ? useDoc().metadata: undefined;
  ...
  const options = [
    ...
    },
    {
      ...
      href: `https://raw.githubusercontent.com/webforj/webforj-documentation/refs/heads/main/docs/docs/${!isDocAutoGenerated() && metadata.id}.md`,
    },
  ];

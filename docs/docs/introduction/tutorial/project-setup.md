...
- In the **webforJ version** dropdown, choose a version of webforJ that's 25.10 or later.
...
Adding `webforj.devtools.browser.open=true` to `application.properties` will automically open a browser when running the `mvn` command.
:::

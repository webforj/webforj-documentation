---
title: <dwc-app-nav-label>
sidebar_class_name: sidebar--item__hidden
slug: app-nav-label
description: Style the dwc-app-nav-label client component with CSS variables, shadow parts, and slots for theming.
---
...
<TableBuilder name="dwc-app-nav-label" clientComponent />

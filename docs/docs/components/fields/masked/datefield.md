...
The `MaskedDateField` is focused solely on **date** values. If you need a similar component for entering and formatting **time**, look into the [`MaskedTimeField`](/docs/components/fields/masked/timefield) instead.
:::

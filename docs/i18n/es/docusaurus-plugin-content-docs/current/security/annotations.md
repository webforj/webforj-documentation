---
sidebar_position: 3
title: Anotaciones de seguridad
...
Esta guía funciona con cualquier implementación de seguridad. Los ejemplos mostrados funcionan tanto con Spring Security como con implementaciones personalizadas. Si no estás usando Spring Boot, consulta la [guía de Arquitectura de Seguridad](/docs/security/architecture/overview) para entender la base y implementar seguridad personalizada.
:::
...
### Requisito de rol único {#single-role-requirement}
...
## Qué sucede cuando se deniega el acceso {#what-happens-when-access-is-denied}

...
Las barras de herramientas ofrecen a los usuarios acceso rápido a acciones clave y elementos de navegación. El componente de webforJ `Toolbar` es un contenedor horizontal que puede contener un conjunto de botones de acción, íconos u otros componentes. Es ideal para gestionar controles de página y albergar funciones clave como una barra de búsqueda o un botón de notificación.
...
Los componentes `Toolbar` incluyen <JavadocLink type="foundation" location="com/webforj/component/Theme">siete temas incorporados</JavadocLink> para una rápida personalización visual:

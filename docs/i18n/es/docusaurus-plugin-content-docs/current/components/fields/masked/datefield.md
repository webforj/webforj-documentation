...
### Sustitución de nombre de mes {#month-name-substitution}
...
Los nombres de los meses pueden aparecer en cualquier posición dentro de la máscara, y el campo seguirá aceptando entrada numérica como alternativa.

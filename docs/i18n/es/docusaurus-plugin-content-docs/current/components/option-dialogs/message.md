...
:::tip Tema del cuadro de diálogo y botones
...
1. **Mensajes claros y concisos**: Mantén los mensajes cortos y directos, y evita jerga técnica; usa un lenguaje amigable para el usuario.
2. **Tipos de mensaje apropiados**:
   - Utiliza `ERROR` para problemas críticos.
   - Utiliza `WARNING` para avisos de precaución.
   - Utiliza `INFO` para información general.
3. **Tematización consistente**: Alinea los temas de los cuadros de diálogo y botones con el diseño de tu aplicación.
...
5. **Evitar el uso excesivo**: Utiliza cuadros de diálogo con moderación para evitar la frustración del usuario y resérvalos para mensajes importantes que requieran acción o reconocimiento del usuario.

...
1. **Descargar Webswing** desde la [página oficial](https://www.webswing.org/en/downloads)
...
- **Nombre de la aplicación**: se convierte en parte de la ruta de la URL (por ejemplo, `miapp` → `http://localhost:8080/miapp/`)
...
La integración de Webswing depende del módulo de integración de Webswing de webforJ, que proporciona el componente `WebswingConnector` y clases relacionadas. 

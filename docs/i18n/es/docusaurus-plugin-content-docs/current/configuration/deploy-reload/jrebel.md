...
---
JRebel es una herramienta de desarrollo Java que se integra con la JVM para detectar cambios en el código y reemplazar clases modificadas directamente en memoria, permitiendo a los desarrolladores ver los cambios en el código de inmediato sin reiniciar el servidor.
...
Los cambios bajo `src/main/frontend` son manejados por el [frontend watch](/docs/configuration/deploy-reload/frontend-watch), que los recompone y actualiza el navegador junto con el servidor.
:::
...
Si se ha hecho correctamente, JRebel mostrará información de registro en la terminal, y los cambios realizados en tu programa deberían reflejarse a demanda.

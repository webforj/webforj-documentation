...
Dit zijn de algemene easing-curven die door de meeste componenten worden gebruikt:
...
## Verminderde beweging {#reduced-motion}

webforJ respecteert de "verminderde beweging" toegankelijkheidsvoorkeur van de gebruiker. Wanneer deze op het besturingssysteemniveau is ingeschakeld, schakelt webforJ automatisch niet-essentiële animaties uit in alle componenten. Geen Java-code is vereist.

:::info Instellingen voor verminderde beweging op besturingssysteemniveau
Waar gebruikers de voorkeur kunnen inschakelen:

- **Windows 10/11**: Instellingen > Toegankelijkheid > Weergave > Animaties in Windows weergeven
- **macOS**: Systeeminstellingen > Toegankelijkheid > Weergave > Verminder beweging
- **iOS**: Instellingen > Toegankelijkheid > Beweging > Verminder beweging

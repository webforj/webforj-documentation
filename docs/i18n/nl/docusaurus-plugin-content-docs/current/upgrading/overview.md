...
:::tip Snapshot builds
Snapshot builds zijn beschikbaar vóór de meeste releases. Gebruikers worden aangemoedigd om deze te testen om vroegtijdig problemen te identificeren en feedback te geven. Zie het [Snapshots](/docs/configuration/snapshots) artikel om te leren hoe je webforJ-snapshots kunt gebruiken en waar je ze kunt verkrijgen.
:::

## Hoe op de hoogte te blijven {#how-to-stay-updated}

### Release-informatie en aankondigingen {#release-notes-and-announcements}
- Elke release gaat vergezeld van gedetailleerde [release-informatie](https://github.com/webforj/webforj/releases) die nieuwe functies, bugfixes en eventuele vereiste acties beschrijft.

...
Pour une compréhension complète des fonctionnalités et des concepts de Spring Security, consultez la [documentation de Spring Security](https://docs.spring.io/spring-security/reference/).
:::

## Ajouter la dépendance Spring Security {#add-spring-security-dependency}
...
## Créer la vue de connexion {#create-login-view}
...
## Créer la vue de refus d'accès {#create-access-denied-view}
...
## Ajouter une fonction de déconnexion {#add-logout-capability}

...
- Le **séparateur de regroupement** est utilisé pour séparer visuellement les milliers (par exemple, `1,000,000`).
...
Le `MaskedNumberFieldSpinner` étend le [`MaskedNumberField`](#basics) en ajoutant des contrôles de spinners qui permettent aux utilisateurs d'augmenter ou de diminuer la valeur à l'aide de boutons de pas ou des touches fléchées. 

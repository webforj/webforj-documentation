...
## 1. Serveur au client {#1-server-to-client}
...
## 2. Client au serveur {#2-client-to-server}
...
## 3. Serveur au client au serveur (aller-retour) {#3-server-to-client-to-server-round-trip}

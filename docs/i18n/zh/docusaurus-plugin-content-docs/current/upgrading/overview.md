...
:::tip 快照构建
快照构建在大多数发布之前提供。鼓励用户对其进行测试，以便及早识别问题并提供反馈。请参阅 [Snapshots](/docs/configuration/snapshots) 文章了解如何使用 webforJ 快照以及在哪里获取它们。
:::

## 如何保持更新 {#how-to-stay-updated}

### 发布说明和公告 {#release-notes-and-announcements}
- 每次发布都会附带详细的 [发布说明](https://github.com/webforj/webforj/releases)，概述新功能、错误修复和任何必要的操作。
...
### 支持与兼容性 {#support-and-compatibility}
